...
import { getKYCRecord } from "@/actions/kyc";
import { KYCReviewClient } from "@/app/(platform)/kyc/[id]/review/_components/kyc-review-client";
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="rounded-xl border border-amber-200 dark:border-amber-800 bg-amber-50 dark:bg-amber-900/10 p-8 text-center">
            <p className="text-amber-700 dark:text-amber-400 font-medium">
              This KYC record cannot be reviewed in its current state (<strong>{record.status}</strong>).
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
            Make a final decision on this KYC submission.
          </p>
        </div>

        <KYCReviewClient record={record} />
      </div>
    </div>
  );
}
