...
export function KYIReviewClient({ record }: KYIReviewClientProps) {
  ...
  async function onSubmit(data: FormData) {
    ...
    if (result.success) {
      toast.success(data.decision === "approved" ? "KYI approved successfully" : "KYI declined");
        ...
        <div className="flex items-center justify-between">
          <div>
            <p className="font-semibold text-slate-800 dark:text-slate-200 flex items-center gap-2">
              ...
              {String(record.institutionInfo?.institutionName ?? "Institution")}
            </p>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          >
            ...
            <div className="text-center">
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">Institution verified</p>
            </div>
          </button>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea placeholder="Provide specific reasons for KYI decline…" rows={3} className="resize-none border-red-200 dark:border-red-800 focus:ring-red-500" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
