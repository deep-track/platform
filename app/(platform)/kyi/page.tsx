...
import { InviteInstitutionDialog } from "./_components/invite-institution-dialog";
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Verify and monitor institutional identities</p>
          </div>

          <div className="flex gap-2 flex-wrap">
            <InviteInstitutionDialog>
              <Button variant="outline">
                <Building2 className="mr-2 h-4 w-4" /> Invite Institution
              </Button>
            </InviteInstitutionDialog>
