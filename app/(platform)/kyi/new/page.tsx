...
interface NewKYIPageProps {
  searchParams: Promise<{ token?: string; email?: string; institution?: string }>;
}
  ...
  return (
    <div className="min-h-full bg-slate-50 dark:bg-slate-950 py-8 px-4 sm:px-6">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Institution Verification</h1>
          <p className="text-slate-500 dark:text-slate-400 mt-1 text-sm max-w-xl">
            Complete the steps below to verify your institution.
          </p>
        ...
        <KYIWizard invitationToken={token} />
      </div>
    </div>
  );
}
