...
export const uboSchema = z.object({
	...
	position: z.enum(["director", "shareholder", "beneficial_owner"], {
...
export const ubosStepSchema = z.object({
	ubos: z.array(uboSchema).min(1, "At least one person is required"),
});

export type UBOsStepData = z.infer<typeof ubosStepSchema>;
...
export type KYBFormData = z.infer<typeof kybFormSchema>;
...
export const createInitialKYBData = (): KYBStepData => ({
	businessInfo: {
		businessName: "",
		registrationNumber: "",
		country: "",
